...
export function DashboardPage() {
  ...
  return (
    <div data-testid="dashboard-page" className="mx-auto w-full max-w-7xl px-4 py-4 sm:px-6 sm:py-6 lg:px-8">
      ...
      <section data-testid="dashboard-stat-cards" className="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3">
        {statCards.map((card) => {
          const Icon = card.icon
          const cardTestId = `dashboard-card-${card.title.toLowerCase().replace(/\s+/g, '-')}`
      ...
      <section data-testid="dashboard-quick-actions" className="mt-5 rounded-xl border border-zinc-200 bg-white p-4 sm:mt-6 sm:p-5">
