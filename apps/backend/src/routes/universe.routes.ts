...
const listUniversesService = new ListUniversesService(
    universeRepository
)

const updateUniverseService = new UpdateUniverseService(
    universeRepository
)

const changeUniverseStatusService = new ChangeUniverseStatusService(
    universeRepository
)
